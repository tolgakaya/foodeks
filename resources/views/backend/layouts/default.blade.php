        ...
        <nav class="navbar navbar-static-top" role="navigation">
            ...
            <div class="navbar-right toggle">
                <ul class="nav navbar-nav  list-inline">
                    {{-- @include('backend.layouts._messages')
                    ...
                    <li class=" nav-item dropdown user user-menu">
                        <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                            ...
                            <img src="{{ asset('backend/images/authors/avatar3.png') }}" alt="img" height="35px"
                                width="35px" class="rounded-circle img-fluid float-left" />

                            @elseif(Sentinel::getUser()->gender === "female")
                            <img src="{{ asset('backend/images/authors/avatar5.png') }}" alt="img" height="35px"
                                width="35px" class="rounded-circle img-fluid float-left" />

                            @else --}}
                            <img src="{{ asset('backend/images/authors/no_avatar.jpg') }}" alt="img" height="35px"
                                width="35px" class="rounded-circle img-fluid float-left" />
                            {{-- @endif --}}
                            <div class="riot">
                                <div>
                                    ...
                                    <p class="user_name_max">{{ Auth::user()->name }}
                                        {{ Auth::user()->email }}</p>
                                    <span>
                                        <i class="caret"></i>
                                    </span>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header bg-light-blue">
                                ...
                                {{ Sentinel::getUser()->last_name }}</p> --}}
                                <p class="topprofiletext">{{ Auth::user()->name }}
                                    {{ Auth::user()->email }}</p>
                            </li>
                            <!-- Menu Body -->
                            <li>
