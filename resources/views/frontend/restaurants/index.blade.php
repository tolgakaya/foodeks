...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-3 hidden-md hidden-xs hidden-sm">
            ...
            <div class="filter_type">
                <a href="{{$adds->link2 ?? '#'}}">
                    <img src="{{$adds->filename2 !=null ? 'images/'.$adds->filename2 : asset('frontend/img/reklam-durum.gif')}}"
                        alt="">
                </a>
            </div>
            <br>
            ...
            <div class="filter_type">
                <a href="{{$adds->link3 ?? '#'}}">
                    <img src="{{$adds->filename3 !=null ? 'images/'.$adds->filename3 : asset('frontend/img/reklam-durum.gif')}}"
                        alt="">
                </a>
            </div>
            <br>
    ...
    <div id="tools">
        <div class="row">
            ...
            <div class="col-md-9 col-sm-9 hidden-xs">
                <a href="{{route('restaurants.index','list')}}" class="bt_filters"><i class="{{'icon-list'}}"></i></a>
            </div>
        </div>
    </div>
    <!--End tools -->
