...
<section class="section">
    <div class="map-item size-2">
        <div class="map-wrapper map-full" id="map-canvas" data-lat="48.8372768" data-lng="2.2393405" data-zoom="14"
            data-marker="img/marker.png" data-style="1"></div>
    ...
    <div class="container">
        ...
        <div class="row">
                ...
                <div class="text-center color-type-2">
                    <div class="contact-icon">
                        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512.192 512.192"
                            width="65px" height="65px" style="enable-background:new 0 0 512.192 512.192;"
                            xml:space="preserve">
                            <g>
                                <g>
                                    <g>
                ...
                <div class="text-center color-type-2">
                    <div class="contact-icon">
                        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                            ...
                            viewBox="0 0 491.582 491.582" style="enable-background:new 0 0 491.582 491.582;"
                            xml:space="preserve">
                            <g>
                                <g>
                                    <path
            ...
            <div class="col-sm-4 col-xs-12">
                ...
                <div class="text-center color-type-2">
                    <div class="contact-icon">
                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 44" width="65px"
                            height="65px" xmlns:xlink="http://www.w3.org/1999/xlink" enable-background="new 0 0 44 44">
                            <g>
                                <g>
                                    <g>
                                        <path
            ...
            <div class="col-md-4 col-md-offset-4 col-xs-12">
                ...
                <div class="text-center color-type-2">
                    ...
                    <div class="follow follow-style-1 sm">
                        ...
                        <a href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                version="1.1" x="0px" y="0px" width="16px" height="16px" viewBox="0 0 604.35 604.35"
