    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <div class="box_style_2 hidden-xs info">
                ...
                <p>
                    Lorem ipsum dolor sit amet, in pri partem essent. Qui debitis meliore ex, tollit debitis
                    conclusionemque te eos.
                </p>
                <hr>
        ...
        <div class="col-md-3" id="sidebar">
            <div class="theiaStickySidebar">
                <div id="cart_box">
                    ...
                    <hr>
                    <a class="btn_full" href="{{route('checkouts.create')}}">Go to checkout</a>
                    <a class="btn_full_outline" href="detail_page.html"><i class="icon-right"></i> Add other
                        items</a>
                </div><!-- End cart_box -->
